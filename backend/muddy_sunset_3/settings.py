"""
Django settings for muddy_sunset_3 project.
...
ROOT_URLCONF = 'muddy_sunset_3.urls'
...
WSGI_APPLICATION = 'muddy_sunset_3.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Muddy Sunset Support <support@muddy-sunset-3.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_sunset_3 API",
    "DESCRIPTION": "API documentation for muddy_sunset_3 App",
    "VERSION": "v1",
}
